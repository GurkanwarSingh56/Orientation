        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md text-xs leading-relaxed">
              Explore → Learn → Build → Connect. A student technology platform created by Technovate for college students across all branches and years.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-white font-bold text-sm mb-3 font-mono">Platform Sections</h3>
